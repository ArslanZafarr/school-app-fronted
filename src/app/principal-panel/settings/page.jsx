...
import { useUserAddProfileMutation } from "@/redux/features/principal-panel/profile/profileApi";
  ...
  return (
    <div className="settings_div">
      <div className="settings_heading d-flex justify-content-between align-items-center">
        ...
        <Link
          href={"/principal-panel/change-password"}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="settings_btn_div d-flex justify-content-center">
              <div
                ...
                style={{ width: "250px" }}
              >
                <Button text="Updated" isLoading={isLoading} />
              </div>
            </div>
            {isError && (
              <p className="error_text text-danger">
