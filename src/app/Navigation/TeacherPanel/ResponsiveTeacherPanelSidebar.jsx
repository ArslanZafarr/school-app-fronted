...
import { teacherPanelSidebarLinks } from './Links.js'
...
const ResponsiveTeacherPanelSidebar = () => {
                ...
                <div className="offcanvas-body">
                    <div>
                        <div className="sidebar mt-4"
                            data-bs-dismiss="offcanvas"
                            aria-label="Close">
                            {teacherPanelSidebarLinks.map((data, index) => (
...
export default ResponsiveTeacherPanelSidebar
