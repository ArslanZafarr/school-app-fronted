...
import { adminPanelSidebarLinks } from './Links';
...
const ResponsiveAdminPanelSidebar = () => {
                ...
                <div className="offcanvas-body">
                    <div>
                        <div className="sidebar mt-4" data-bs-dismiss="offcanvas"
                            aria-label="Close">
                            {adminPanelSidebarLinks.map((data, index) => (
                        ...
                        <button
                            ...
                            className={`btn hover_color d-flex text-dark logout_btn `}>
...
export default ResponsiveAdminPanelSidebar
